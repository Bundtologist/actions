...
const DONATION_AMOUNT_SOL_OPTIONS = [0.1, 1, 10];
...
> {
  const icon =
    'https://i.gyazo.com/a96df11d1e7fd3e5fb5f7657c0c8c9cb.png';
  const title = 'Donate to Bundt';
  const description =
    'Blockchain Developer | Support my coding with a donation!';
